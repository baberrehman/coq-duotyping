(**************************************************************************************************
* Preservation and Progress for System-F kernel with Subtyping                                      *
...
Lemma Var_binds : forall E C X,
    sub E C (typ_fvar X) ->
    forall T, wft E T -> binds X (bind_sub T) E -> sub E C T.
  introv r.
  dependent induction r; intros; try (destruct m; inversion x; fail); eauto.
  + eapply sub_trans_tvar; eauto. apply sub_reflexivity; auto.
  + eapply sub_trans_tvar; eauto.
Defined.
