(**************************************************************************************************
* Preservation and Progress for simple polymorphic calculus with duotyping, Union and Intersection types *
...
Proof.
  ...
  destruct m. simpl. apply* SLeft2. simpl. apply* SLeft2.
  destruct m. simpl. apply* SRight1. simpl. apply* SRight1.
  destruct m. simpl. apply* SRight2. simpl. apply* SRight2.
  destruct m. simpl. apply* SBoth1. simpl. apply* SBoth1.
  destruct m. simpl. apply* SBoth2. simpl. apply* SBoth2.
Qed. 
  
(* TODO: BABER Finish this - Done *)
