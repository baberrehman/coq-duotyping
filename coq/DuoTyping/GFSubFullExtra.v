...
| RSAll : forall E L m1 m2 T1 T2 T3 T4, 
  RS E (BindPosVariance m1 m2) T1 T2 ->
(forall X, X \notin L ->
  RS (E&(X !: m1 <>: (SelectBound m2 T1 T2))) m2 (T3 open_tt_var X) (T4 open_tt_var X))-> 
  RS E m2 (typ_all m1 T1 T3) (typ_all m1 T2 T4)
...
| R2All : forall E L m1 m2 T1 T2 T3 T4 b, 
  R2 E true (BindPosVariance m1 m2) T1 T2 ->
(forall X, X \notin L ->
  R2 (E&(X !: m1 <>: (SelectBound m2 T1 T2))) true m2 (T3 open_tt_var X) (T4 open_tt_var X))-> 
  R2 E b m2 (typ_all m1 T1 T3) (typ_all m1 T2 T4)
